...
```bash
curl -fsSL https://raw.githubusercontent.com/jialmaster/SillyDroid/main/scripts/export-tavern-data.sh | bash
```
...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/jialmaster/SillyDroid/main/scripts/export-tavern-data.sh) \
